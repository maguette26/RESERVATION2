...
<div class="container mt-5">
    <h1 class="text-center mb-4 text-primary">Modifier l'Événement</h1>
    @if (session('success'))
    ...
    <form class="card mx-auto" style="max-width: 1000px;" action="{{ route('admin.update', $event->id) }}" method="post" enctype="multipart/form-data">
        @csrf
        @method('PUT')
