...
<head>
    ...
    <!-- Custom Styles for Copperplate -->
    <style>
        /* Applique Copperplate à tout le document */
        body {
            font-family: 'Copperplate', serif;
        }

        /* Change la couleur du texte des liens de navigation en noir */
        .navbar-nav .nav-link {
            color: #000 !important; /* Noir */
        }

        /* Change la couleur du texte des liens du menu déroulant en noir */
        .dropdown-menu .dropdown-item {
            color: #000 !important; /* Noir */
        }

        /* Change la couleur du texte du bouton dropdown en noir */
        .btn-secondary {
            color: #000 !important; /* Noir */
        }
    </style>
        ...
        <div class="container">
            <nav class="navbar navbar-light navbar-expand-lg py-4">
                <a href="{{ url('/')}}" class="navbar-brand">
                    <h1 class="text-primary fw-bold mb-0">SenReserv<span class="text-dark"> Events</span></h1>
                </a>
